        ...
        <!-- Service Blcoks -->
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <select name="postbox" class="form-control" disabled="True">
                    <option> 
                    <!-- Code to get type of post -->
                    <?php
            ...
            <div class="row">
              <div class="col-md-12">
                <button class="btn btn-primary" type="submit" name="post-submit">Update</button></div>
              </form>
            </div>  
        </div>
			</div>
