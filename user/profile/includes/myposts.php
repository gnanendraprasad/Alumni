	            ...
	            ?>
                  ...
                  <!--  <div class="post-cover">
                        <div class="post">
                            ...
                            <div class="innercontent">
                            <img src="img/icons/new.gif" alt="new gif Image">
...
<!-- Upcoming events starts -->
		<div class="ue">
            ...
            <div class="ue-contain" id="style-1">
					...
					?>
                <!--<div class="ue-posts-cover">
                    <div class="ue-posts">
                    <div class="ue-icon">
                    </div>
                    <div class="ue-info">
                        <div class="ue-desc">
                            <p>Job Description - Prior to posting a job, be thoughtful about the company profile and job description to ensure the posting speaks to the values,
                                mission and culture of the company.<span>DateofEvent</span></p>
                        </div>
                        </div>
                    </div>
                    <div class="ue-separator"></div>
