<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
                   ...
                   <a href="?"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                       ...
                       <li>
                            ...
                            <ul class="nav nav-second-level">
                                <!--<li>
                                    <a href="add-course.php">Add Post</a>
                                </li>-->
                                <li>
                                    <a href="view-course.php">View Post</a>
                                </li>
                            </ul>
                            </li>
                ...
                <!-- <li>
                  ...
                  <li>
                            <a href="session.php"><i class="fa fa-bar-chart-o fa-fw"></i>Register Student<span class="fa arrow"></span></a>
                  </li>
                   <li>
