                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                     ...
                                     while($res=$rs->fetch_object()){
	                                  ...
	                                  $c=$res->user_usn;
									                  $cname=$obj->showSubject($c);
									                  $res1=$cname->fetch_object();

									 ?>
                                        <tr class="odd gradeX">
                              <td><?php echo $sn?></td>
                              <td><?php echo htmlentities( strtoupper($res->user_usn));?></td>
             <td><?php echo htmlentities(strtoupper($res->name));?></td>
       <td><?php echo htmlentities(strtoupper($res->user_email));?></td>
	  <td><?php echo htmlentities($res->mob);?></td>
	  <td><?php echo htmlentities(strtoupper($res->branch));?></td>
      <td><?php echo htmlentities(strtoupper($res->batch));?></td>
			<td><?php
			if($res->flag2=='1'){
				echo'Accepted';
			}
